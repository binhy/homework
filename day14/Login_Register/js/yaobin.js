...
(function (jq) {
    ...
    jq.extend({
        ...
        'CheckAll':function (abc) {
           $(abc).find(":checkbox").attr('checked',true);
       },
        'UnCheckAll':function (abc) {
          $(abc).find(":checkbox").attr('checked',false)
        },
        'ReverseCheck':function (abc) {
          $(abc).find(":checkbox").each(function () {
